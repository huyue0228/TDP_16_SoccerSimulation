function [players,playerOriginalPosition,playerStickPosition] = PlayersInitialPositions(formation1,formation2,attributes,kickoffTeam,goalsTeam0,goalsTeam1)
...
playerStickPosition=zeros(nPlayers,2);
...
if goalsTeam0==goalsTeam1 % Red team tied with blue teama
    ...
    playerOriginalPosition(1:nPlayers,1)=players{1}(1:nPlayers,1);
    playerOriginalPosition(1:nPlayers,2)=players{1}(1:nPlayers,2);
    playerStickPosition=[
        10 -12;
        10 12;
        -25 0;
